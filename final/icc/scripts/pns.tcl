...
set_fp_block_ring_constraints -add -horizontal_layer METAL5 -horizontal_width 3 -horizontal_offset 0.600 -vertical_layer METAL4 -vertical_width 3 -vertical_offset 0.600 -block_type instance  -block {I_RISC_CORE/I_REG_FILE/REG_FILE_A_RAM} -net  {VDD VSS}
set_fp_block_ring_constraints -add -horizontal_layer METAL5 -horizontal_width 3 -horizontal_offset 0.600 -vertical_layer METAL4 -vertical_width 3 -vertical_offset 0.600 -block_type instance  -block {I_RISC_CORE/I_REG_FILE/REG_FILE_A_RAM} -net  {VDD VSS}
